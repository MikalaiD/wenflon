...
public @interface Wenflon {
     ...
     * If <b>false</b> then condition will always be checked, even for the single implementation. In case condition is not met the {@link io.github.mikalaid.wenflon.exceptions.WenflonException }
     * will be thrown.
     *
     * @return
     *
